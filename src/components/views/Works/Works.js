...
function Works() {
  return (
    <div className={styles.container}>
      <svg xmlns="http://www.w3.org/2000/svg" width="1301" height="952" viewBox="0 0 1301 952" className={styles.stars}>
      ...
      <div className={`${styles.box} ${styles.first}`}>
        <div className={`${styles.boxImage} ${styles.shop}`}>
          <a href='https://baza-store-group-project.herokuapp.com/' target='_blanket'>
            <div className={styles.boxOverlay}>
              <p className={styles.boxOverlayText}>DEMO</p>
            </div>
          </a>
